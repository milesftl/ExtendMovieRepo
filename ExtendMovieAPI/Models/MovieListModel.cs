...
namespace ExtendMovieAPI.Models
{
    public class MovieListModel
    {
        ...
        [JsonIgnore] public string _GenreIds { get; set; }

        [NotMapped]
        [JsonProperty("genre_ids")]
        public List<int> GenreIds
        {
            get => string.IsNullOrEmpty(_GenreIds) ? null : JsonConvert.DeserializeObject<List<int>>(_GenreIds);
            set => _GenreIds = JsonConvert.SerializeObject(value);
        }
    ...
    public class MovieListHeaderModel
    {
        ...
        [JsonProperty("results")] public List<MovieListModel> MovieList { get; set; }
    }

    public class GenreIDsList
    {
        [Key] [JsonProperty("genre_ids")] public int GenreId { get; set; }
    }
}